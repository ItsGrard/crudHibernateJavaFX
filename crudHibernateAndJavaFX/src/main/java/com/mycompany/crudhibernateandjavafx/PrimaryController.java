...
public class PrimaryController implements Initializable {
    ...
    private void click(MouseEvent event) {
        //Mio
        //Query q = s.createQuery("UPDATE Pedido SET estado = 'Recogido'", Pedido.class);
       Pedido p = tabla.getSelectionModel().getSelectedItem();
         Transaction t = s.beginTransaction();
            //pedido = s.load(Pedido.class, id);
...
en una fila determinada.
         */
        Integer recogiendo = tabla.getSelectionModel().getSelectedItem().getId();
